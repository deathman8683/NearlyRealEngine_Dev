...
ifeq ($(TARGET), debug)
	...
	BIN = bin/Debug/
	SOURCE = Source
	OBJ = $(OBJDIR)Maths/NRE_Maths.o $(OBJDIR)Generic/Command/BaseCommand/NRE_BaseCommand.o $(OBJDIR)Generic/Array/NRE_ArrayOperation.o $(OBJDIR)Generic/Init/NRE_Init.o $(OBJDIR)Exception/NRE_ExceptionHandler.o $(OBJDIR)Exception/ShaderException/NRE_ShaderException.o $(OBJDIR)Exception/SupportException/NRE_SupportException.o $(OBJDIR)Exception/SDLException/NRE_SDLException.o $(OBJDIR)Exception/GLException/NRE_GLException.o $(OBJDIR)Exception/IOException/NRE_IOException.o $(OBJDIR)Exception/IOException/FileNotExistingException/NRE_FileNotExistingException.o $(OBJDIR)Exception/IOException/FileNotOpeningException/NRE_FileNotOpeningException.o $(OBJDIR)Exception/SecurityException/NRE_SecurityException.o $(OBJDIR)Exception/AssimpException/NRE_AssimpException.o $(OBJDIR)lib/FastNoise/FastNoise.o $(OBJDIR)SDL_Wrapper/Window/NRE_Window.o $(OBJDIR)SDL_Wrapper/Event/NRE_Event.o $(OBJDIR)SDL_Wrapper/PixelFormat/NRE_PixelFormat.o $(OBJDIR)SDL_Wrapper/Surface/NRE_Surface.o $(OBJDIR)GL_Wrapper/Buffer/NRE_Buffer.o $(OBJDIR)GL_Wrapper/Buffer/AttributeBuffer/NRE_AttributeBuffer.o $(OBJDIR)GL_Wrapper/Buffer/AttributeBuffer/ArrayBuffer/NRE_ArrayBuffer.o $(OBJDIR)GL_Wrapper/Buffer/AttributeBuffer/ArrayBuffer/VertexBuffer/NRE_VertexBuffer.o $(OBJDIR)GL_Wrapper/Buffer/AttributeBuffer/ArrayBuffer/ColorBuffer/NRE_ColorBuffer.o $(OBJDIR)GL_Wrapper/Buffer/AttributeBuffer/ArrayBuffer/MaterialBuffer/NRE_MaterialBuffer.o $(OBJDIR)GL_Wrapper/Buffer/AttributeBuffer/ArrayBuffer/NormalBuffer/NRE_NormalBuffer.o $(OBJDIR)GL_Wrapper/Buffer/AttributeBuffer/ArrayBuffer/TangentBuffer/NRE_TangentBuffer.o $(OBJDIR)GL_Wrapper/Buffer/AttributeBuffer/ArrayBuffer/UVBuffer/NRE_UVBuffer.o $(OBJDIR)GL_Wrapper/Buffer/AttributeBuffer/IndexBuffer/NRE_IndexBuffer.o $(OBJDIR)GL_Wrapper/Buffer/DepthBuffer/NRE_DepthBuffer.o $(OBJDIR)GL_Wrapper/Buffer/TextureBuffer/NRE_TextureBuffer.o $(OBJDIR)GL_Wrapper/Buffer/TextureBuffer/2D/NRE_Texture2DBuffer.o $(OBJDIR)GL_Wrapper/Buffer/TextureBuffer/3D/NRE_Texture3DBuffer.o $(OBJDIR)GL_Wrapper/Buffer/CubeMap/NRE_CubeMap.o $(OBJDIR)GL_Wrapper/Buffer/FrameBuffer/NRE_FrameBuffer.o $(OBJDIR)GL_Wrapper/Buffer/RenderBuffer/NRE_RenderBuffer.o $(OBJDIR)GL_Wrapper/Buffer/VAO/NRE_VAO.o $(OBJDIR)GL_Wrapper/BufferObject/NRE_BufferObject.o $(OBJDIR)GL_Wrapper/BufferObject/VBO/NRE_VBO.o $(OBJDIR)GL_Wrapper/BufferObject/IBO/NRE_IBO.o $(OBJDIR)GL_Wrapper/BufferObject/Texture2D/NRE_Texture2D.o $(OBJDIR)GL_Wrapper/BufferObject/Texture2DArray/NRE_Texture2DArray.o $(OBJDIR)GL_Wrapper/BufferObject/SkyBox/NRE_SkyBox.o $(OBJDIR)GL_Wrapper/BufferObject/FBO/NRE_FBO.o $(OBJDIR)IO/File/NRE_File.o $(OBJDIR)IO/FileStream/NRE_FileStream.o $(OBJDIR)IO/FileStream/IOFile/NRE_IOFile.o $(OBJDIR)IO/FileStream/Input/InputStream/NRE_InputStream.o $(OBJDIR)IO/FileStream/Input/InputFile/NRE_InputFile.o $(OBJDIR)IO/FileStream/Output/OutputStream/NRE_OutputStream.o $(OBJDIR)IO/FileStream/Output/OutputFile/NRE_OutputFile.o $(OBJDIR)IO/FileStream/BinaryStream/BinaryInput/BinaryInputStream/NRE_BinaryInputStream.o $(OBJDIR)IO/FileStream/BinaryStream/BinaryInput/BinaryInputFile/NRE_BinaryInputFile.o $(OBJDIR)IO/FileStream/BinaryStream/BinaryOutput/BinaryOutputStream/NRE_BinaryOutputStream.o $(OBJDIR)IO/FileStream/BinaryStream/BinaryOutput/BinaryOutputFile/NRE_BinaryOutputFile.o $(OBJDIR)IO/FileStream/BinaryStream/BinaryIOFile/NRE_BinaryIOFile.o $(OBJDIR)Object/Mesh/Data/DataSet/NRE_DataSet.o $(OBJDIR)Object/Mesh/Data/IntVertexData/NRE_IntVertexData.o $(OBJDIR)Object/Mesh/Data/FloatVertexData/NRE_FloatVertexData.o $(OBJDIR)Object/Mesh/Data/IndexData/NRE_IndexData.o $(OBJDIR)Object/Mesh/Data/MaterialData/NRE_MaterialData.o $(OBJDIR)Object/Mesh/Data/NormalData/NRE_NormalData.o $(OBJDIR)Object/Mesh/Data/TangentData/NRE_TangentData.o $(OBJDIR)Object/Mesh/Data/UVData/NRE_UVData.o $(OBJDIR)Object/Mesh/Data/ColorData/NRE_ColorData.o $(OBJDIR)Object/MergingCache/NRE_MergingCache.o $(OBJDIR)Object/VoxelSet/NRE_VoxelSet.o $(OBJDIR)Object/Mesh/NRE_Mesh.o $(OBJDIR)Object/Mesh/2D/NRE_Mesh2D.o $(OBJDIR)Object/Mesh/3D/NRE_Mesh3D.o $(OBJDIR)Object/Mesh/3D/VoxelMesh/NRE_VoxelMesh.o $(OBJDIR)Object/NRE_Object.o $(OBJDIR)Object/2D/NRE_Object2D.o $(OBJDIR)Object/3D/NRE_Object3D.o $(OBJDIR)Object/3D/VoxelObject/NRE_VoxelObject.o $(OBJDIR)Time/Timestep/NRE_Timestep.o $(OBJDIR)Time/Date/NRE_Date.o $(OBJDIR)Time/AdvancedDate/NRE_AdvancedDate.o $(OBJDIR)Time/Clock/NRE_Clock.o $(OBJDIR)Renderer/Color/RGB/NRE_RGB.o $(OBJDIR)Renderer/Color/HSL/NRE_HSL.o $(OBJDIR)Renderer/Color/RGB/NRE_RGBA.o $(OBJDIR)Renderer/Color/HSL/NRE_HSLA.o $(OBJDIR)Renderer/Color/NRE_ColorConverter.o $(OBJDIR)Renderer/Shader/ShaderBase/NRE_ShaderBase.o $(OBJDIR)Renderer/Shader/ShaderBase/VertexShader/NRE_VertexShader.o $(OBJDIR)Renderer/Shader/ShaderBase/FragmentShader/NRE_FragmentShader.o $(OBJDIR)Renderer/Shader/ShaderMap/NRE_ShaderMap.o $(OBJDIR)Renderer/Shader/NRE_Shader.o $(OBJDIR)Renderer/Shader/ShadersManager/BRDF/NRE_BRDFShader.o $(OBJDIR)Renderer/Shader/ShadersManager/Capture/NRE_CaptureShader.o $(OBJDIR)Renderer/Shader/ShadersManager/GBuffer/NRE_GBufferShader.o $(OBJDIR)Renderer/Shader/ShadersManager/Irradiance/NRE_IrradianceShader.o $(OBJDIR)Renderer/Shader/ShadersManager/PBR/NRE_PBRShader.o $(OBJDIR)Renderer/Shader/ShadersManager/Prefilter/NRE_PrefilterShader.o $(OBJDIR)Renderer/Shader/ShadersManager/SkyBox/NRE_SkyBoxShader.o $(OBJDIR)Renderer/Shader/ShadersManager/SSAO/NRE_SSAOShader.o $(OBJDIR)Renderer/Shader/ShadersManager/NRE_ShadersManager.o $(OBJDIR)Renderer/SSAO/NRE_SSAO.o $(OBJDIR)Renderer/Material/NRE_Material.o $(OBJDIR)Renderer/Material/MaterialsManager/NRE_MaterialsManager.o $(OBJDIR)Renderer/EnvironmentMap/NRE_EnvironmentMap.o $(OBJDIR)Renderer/DeferredRenderer/NRE_DeferredRenderer.o $(OBJDIR)Light/NRE_Light.o $(OBJDIR)Light/SpotLight/NRE_SpotLight.o $(OBJDIR)Light/DirectionnalLight/NRE_DirectionnalLight.o $(OBJDIR)Light/PointLight/NRE_PointLight.o $(OBJDIR)Light/LightsManager/NRE_LightsManager.o $(OBJDIR)Camera/Input/KeyBinder/Key/NRE_Key.o $(OBJDIR)Camera/Input/KeyBinder/NRE_KeyBinder.o $(OBJDIR)Camera/Input/Keyboard/NRE_Keyboard.o $(OBJDIR)Camera/Input/EventHandler/NRE_EventHandler.o $(OBJDIR)Camera/Input/Mouse/NRE_Mouse.o $(OBJDIR)Camera/Input/NRE_Input.o $(OBJDIR)Camera/FixedCamera/NRE_FixedCamera.o $(OBJDIR)Camera/NRE_MoveableCamera.o $(OBJDIR)World/Voxel/Type/VoxelType/NRE_VoxelType.o $(OBJDIR)World/Voxel/Type/VoxelType/Type/NRE_Type.o $(OBJDIR)World/Voxel/Type/VoxelTypes/NRE_VoxelTypes.o $(OBJDIR)World/Voxel/VoxelPoint/NRE_VoxelPoint.o $(OBJDIR)World/Voxel/NRE_Voxel.o $(OBJDIR)World/Chunk/NRE_Chunk.o $(OBJDIR)World/Chunk/ChunksManager/NRE_ChunksManager.o $(OBJDIR)World/Region/NRE_Region.o $(OBJDIR)World/Region/RegionsManager/NRE_RegionsManager.o $(OBJDIR)World/NRE_World.o $(OBJDIR)Support/Viewport/NRE_Viewport.o $(OBJDIR)Support/Stage/NRE_Stage.o $(OBJDIR)Support/Application/NRE_Application.o $(OBJDIR)NRE_Main.o
...
clean :
	...
	@mkdir obj/Debug/Exception/SecurityException
	@mkdir obj/Debug/Exception/SDLException
	@mkdir obj/Debug/Exception/GLException
	@mkdir obj/Debug/Exception/IOException
	@mkdir obj/Debug/Exception/IOException/FileNotExistingException
	@mkdir obj/Debug/Exception/IOException/FileNotOpeningException
	...
	@mkdir obj/Debug/IO
	@mkdir obj/Debug/IO/File
	@mkdir obj/Debug/IO/FileStream
	@mkdir obj/Debug/IO/FileStream/BinaryStream
	@mkdir obj/Debug/IO/FileStream/BinaryStream/BinaryIOFile
	@mkdir obj/Debug/IO/FileStream/BinaryStream/BinaryInput
	@mkdir obj/Debug/IO/FileStream/BinaryStream/BinaryInput/BinaryInputFile
	@mkdir obj/Debug/IO/FileStream/BinaryStream/BinaryInput/BinaryInputStream
	@mkdir obj/Debug/IO/FileStream/BinaryStream/BinaryOutput
	@mkdir obj/Debug/IO/FileStream/BinaryStream/BinaryOutput/BinaryOutputFile
	@mkdir obj/Debug/IO/FileStream/BinaryStream/BinaryOutput/BinaryOutputStream
	@mkdir obj/Debug/IO/FileStream/IOFile
	@mkdir obj/Debug/IO/FileStream/Input
	@mkdir obj/Debug/IO/FileStream/Input/InputFile
	@mkdir obj/Debug/IO/FileStream/Input/InputStream
	@mkdir obj/Debug/IO/FileStream/Output
	@mkdir obj/Debug/IO/FileStream/Output/OutputFile
	@mkdir obj/Debug/IO/FileStream/Output/OutputStream
	...
	@mkdir obj/Debug/Renderer/Shader/ShadersManager
	@mkdir obj/Debug/Renderer/Shader/ShadersManager/BRDF
	@mkdir obj/Debug/Renderer/Shader/ShadersManager/Capture
	@mkdir obj/Debug/Renderer/Shader/ShadersManager/GBuffer
	@mkdir obj/Debug/Renderer/Shader/ShadersManager/Irradiance
	@mkdir obj/Debug/Renderer/Shader/ShadersManager/PBR
	@mkdir obj/Debug/Renderer/Shader/ShadersManager/Prefilter
	@mkdir obj/Debug/Renderer/Shader/ShadersManager/SkyBox
	@mkdir obj/Debug/Renderer/Shader/ShadersManager/SSAO
	...
	@mkdir obj/Debug/Renderer/Material/MaterialsManager
	...
	@mkdir obj/Debug/Light/LightsManager
	...
	@mkdir obj/Debug/Support/Application
	...
	@mkdir obj/Debug/World/Chunk/ChunksManager
	@mkdir obj/Debug/World/Region
	@mkdir obj/Debug/World/Region/RegionsManager
