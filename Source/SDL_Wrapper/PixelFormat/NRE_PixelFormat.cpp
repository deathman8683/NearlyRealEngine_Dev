    ...
    namespace NRE {
        namespace SDL {
            ...
            PixelFormat& PixelFormat::operator=(PixelFormat const& pf) {
                item = pf.item;
                allocated = pf.allocated;
                return *this;
            }

            PixelFormat& PixelFormat::operator=(PixelFormat && pf) {
                item = std::move(pf.item);
                allocated = std::move(pf.allocated);
                return *this;
            }
