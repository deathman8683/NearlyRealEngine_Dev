    ...
    int main(int argc, char **argv) {
        ...
        Renderer::Shader deferredShader("Shaders/DeferredShader.vert", "Shaders/DeferredShader.frag", true);
        ...
        Renderer::DeferredRenderer engineDeferredRenderer(Maths::Vector2D<NREfloat>(800, 600));
        ...
        while(!camera.getQuit())
        {
            ...
            engineDeferredRenderer.startFBO();
                ...
                engineSkybox.render(deferredShader, modelviewFBO, projectionFBO, cameraFBO.getEye());
                engineSkybox.bind();
                    engineWorld.render(deferredShader, modelviewFBO, projectionFBO, cameraFBO, engineLighting);
                engineSkybox.unbind();

            engineDeferredRenderer.endFBO();

            engineDeferredRenderer.render(deferredRendering);
