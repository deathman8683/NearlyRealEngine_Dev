        ...
        namespace Light {
            ...
            class DirectionnalLight : public Light {
                ...
                public:
                    //## Constructor ##//
                    DirectionnalLight();
                    DirectionnalLight(Maths::Point3D<NREfloat> const& coord, Maths::Vector3D<NREfloat> const& color, Maths::Maths::Vector3D<NREfloat> direction, NREfloat const& ambientCoeff);
